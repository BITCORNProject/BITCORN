...
class ConfArgsTest(BitCornTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'bitcorn.conf'), 'a', encoding='utf-8') as conf:
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "bitcorn.conf")
        ...
        # Temporarily disabled, because this test would access the user's home dir (~/.bitcorn)
