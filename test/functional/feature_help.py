...
"""Verify that starting bitcorn with -h works as expected."""
...
class HelpTest(BitCornTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcorn with -h for help text")
        ...
        self.log.info("Start bitcorn with -version for version information")
        ...
        self.log.info("Start bitcornd with -fakearg to make sure it does not start")
