...
class HelpTest(BitCornTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitgreen with -h for help text")
        ...
        self.log.info("Start bitgreen with -version for version information")
        ...
        self.log.info("Start bitgreend with -fakearg to make sure it does not start")
