# Bootstrappable BitCorn Core Builds

This directory contains the files necessary to perform bootstrappable BitCorn
Core builds.
...
- 24GB of free disk space on the partition that the BitCorn Core git repository
  resides in
...
For a BitCorn Core depends development environment, simply invoke
...
From the top of a clean BitCorn Core repository:
...
To use dongcarl's substitute server for BitCorn Core builds after having
