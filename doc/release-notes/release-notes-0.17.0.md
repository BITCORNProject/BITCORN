...
- #11771 `2dbc4a4` Change invalidtxrequest to use BitCornTestFramework (jnewbery)
...
- #11772 `0630974` Change invalidblockrequest to use BitCornTestFramework (jnewbery)
...
- #11773 `f0f9732` Change `feature_block.py` to use BitCornTestFramework (jnewbery)
- #12839 `40f4baf` Remove travis checkout depth (laanwj)
- #11817 `2a09a78` Change `feature_csv_activation.py` to use BitCornTestFramework (jnewbery)
...
- #12856 `27278df` Add Metaclass for BitCornTestFramework (WillAyd)
