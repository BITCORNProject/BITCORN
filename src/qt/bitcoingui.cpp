...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitgreen: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a bitgreen: URI or payment request"));
