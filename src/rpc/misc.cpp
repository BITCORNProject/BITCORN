    ...
    if (request.fHelp || request.params.size() != 2) {
        ...
        if(sporkManager.UpdateSpork(nSporkID, nValue)){
            ...
            throw std::runtime_error(
                ...
                "\nExamples:\n"
                + HelpExampleCli("spork", "SPORK_5_INSTANTSEND_ENABLED 4070908800")
                + HelpExampleRpc("spork", "\"SPORK_5_INSTANTSEND_ENABLED\", 4070908800"));
        }
    }
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given bitcorn address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitcorn address to validate"},
                },
                RPCResult{
            "{\n"
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitcorn address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "bitcorn-cli and the GUI. There is no server-side difference.",
                {},
                RPCResults{},
                RPCExamples{""},
            }.ToString()
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* BitCorn features */
    { "bitcorn",           "mnsync",                 &mnsync,                 {} },
    { "bitcorn",           "spork",                  &spork,                  {"mode"} },
