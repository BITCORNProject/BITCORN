...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated bitcorn to."},
            ...
            + "If you are running the bitcorn core wallet, you can get a new address to send the newly generated bitcorn to with:\n"
...
// NOTE: Unlike wallet RPC (which use CORN values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    ...
    bool accepted = ProcessNewBlock(Params(), blockptr, true, &new_block, &fSpamNode);
