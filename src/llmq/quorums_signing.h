...
#ifndef BITCORN_LLMQ_QUORUMS_SIGNING_H
#define BITCORN_LLMQ_QUORUMS_SIGNING_H
...
private:
    ...
    void ProcessPendingReconstructedRecoveredSigs(CConnman* connman);
...
#endif //BITCORN_LLMQ_QUORUMS_SIGNING_H
