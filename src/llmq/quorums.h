...
private:
    void WriteContributions(CSpecialDB& specialDb);
    bool ReadContributions(CSpecialDB& specialDb);
...
public:
    CQuorumManager(CSpecialDB& _specialDb, CBLSWorker& _blsWorker, CDKGSessionManager& _dkgManager);
